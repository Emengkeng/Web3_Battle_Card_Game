...
import "./interface/IAvaxGods.sol";
import "./interface/ISluppyToken.sol";
...
contract NFTStakingVault is Ownable, IERC721Receiver {
    ...
    IAvaxGods immutable nft;
    ISluppyToken immutable token;
    ...
    constructor(address _nftAddress, address _tokenAddress) {
        nft = IAvaxGods(_nftAddress);
        token = ISluppyToken(_tokenAddress);
    }
